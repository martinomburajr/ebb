...
//	tests := []struct {
//		name    string
//		fields  *RRCompetition
//		wantErr bool
//	}{
//		{"nil-protagonist", &RRCompetition{}, true},
//		//{"nil-antagonist", &RRCompetition{protagonist: &IndividualProg0Kind0}, true},
//		//{"err-applyAntagonistStrategy", &RRCompetition{protagonist: &IndividualProg0Kind0, antagonist: &IndividualProg0Kind0},
//		//	true},
//		//{"err-applyAntagonistStrategy", &RRCompetition{protagonist: &IndividualProg0Kind0, antagonist: &IndividualProg0Kind0},
//		//	true},
//	}
...
//		//	}
//		//	if err := e.TopologyRoundRobin(); (err != nil) != tt.wantErr {
//		//		t.Errorf("RRCompetition.TopologyRoundRobin() error = %v, wantErr %v", err, tt.wantErr)
//		//	}
//		//})
//	}
//}
...
func TestEpoch_applyProtagonistStrategy(t *testing.T) {
	...
	//			t.Errorf("RRCompetition.applyProtagonistStrategy() error = %v, wantErr %v", err, tt.wantErr)
	//		}
	//	})
	//}
}
