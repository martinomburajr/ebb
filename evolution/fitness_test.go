...
//
//var xx25Spec, _ = NewSpec(SpecParam{Expression: "x*x", Range: 5, Seed: -2}, FitnessStrategy{Type: FitnessRatio})
//
//var xSpec, _ = NewSpec(SpecParam{Expression: "x", Range: 0, Seed: 1}, FitnessStrategy{Type: FitnessRatio})
//var xSpecMono, _ = NewSpec(SpecParam{Expression: "x", Range: 0, Seed: 1}, FitnessStrategy{Type: FitnessRatio})
//var xSpecCount10, _ = NewSpec(SpecParam{Expression: "x", Range: 0, Seed: 1}, FitnessStrategy{Type: FitnessRatio})
//var xSpecCount10Mono, _ = NewSpec(SpecParam{Expression: "x", Range: 0, Seed: 1}, FitnessStrategy{Type: FitnessRatio})
//var xSpecCount100, _ = NewSpec(SpecParam{Expression: "x", Range: 0, Seed: 1}, FitnessStrategy{Type: FitnessRatio})
//var xSpecCount100Mono, _ = NewSpec(SpecParam{Expression: "x", Range: 0, Seed: 1},
//	FitnessStrategy{Type: FitnessRatio})
//var xxSpecCount100, _ = NewSpec(SpecParam{Expression: "x*x", Range: 0, Seed: 1}, FitnessStrategy{Type: FitnessRatio})
//var xxSpecCount100Mono, _ = NewSpec(SpecParam{Expression: "x*x", Range: 0, Seed: 1}, FitnessStrategy{Type: FitnessRatio})
